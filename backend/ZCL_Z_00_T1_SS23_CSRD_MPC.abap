class ZCL_Z_00_T1_SS23_CSRD_MPC definition
  public
...
public section.
  ...
  types:
     TS_FORMSCHEMA type Z00T1_FSCHEMA .
  types:
TT_FORMSCHEMA type standard table of TS_FORMSCHEMA .
  types:
  ...
  types:
     TS_FORMSCHEMARESULT type Z00T1_FSCHEMARES .
  types:
TT_FORMSCHEMARESULT type standard table of TS_FORMSCHEMARESULT .
  types:
     TS_CUSTOMER type Z00T1_CUSTOMER .
  types:
TT_CUSTOMER type standard table of TS_CUSTOMER .
  ...
  constants GC_FORMSCHEMA type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'FormSchema' ##NO_TEXT.
  constants GC_FORMSCHEMARESULT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'FormSchemaResult' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_00_T1_SS23_CSRD_MPC=====CP' ##NO_TEXT.

  methods DEFINE_FORMSCHEMA
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_FORMSCHEMARESULT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_Z_00_T1_SS23_CSRD_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_00_T1_SS23_CSRD_SRV' ).

define_formschema( ).
define_formschemaresult( ).
define_customer( ).
  endmethod.
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'CustomerCode' iv_abap_fieldname = 'CUSTOMERCODE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 255 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UpdatedAt' iv_abap_fieldname = 'UPDATEDAT' ). "#EC NOTEXT
lo_property->set_type_edm_datetime( ).
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
lo_property->set_sortable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name   = 'Z00T1_CUSTOMER'
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'FormSchema' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SchemaJson' iv_abap_fieldname = 'SCHEMAJSON' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'MetadataJson' iv_abap_fieldname = 'METADATAJSON' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'Z00T1_FSCHEMA'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'FormSchemaSet' ). "#EC NOTEXT
...
lo_entity_set->set_filter_required( abap_false ).
  ...
  method DEFINE_FORMSCHEMARESULT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
***********************************************************************************************************************************
*   ENTITY - FormSchemaResult
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'FormSchemaResult' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'FormSchemaId' iv_abap_fieldname = 'FORMSCHEMAID' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 36 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ResultJson' iv_abap_fieldname = 'RESULTJSON' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'Z00T1_FSCHEMARES'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'FormSchemaResultSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230706121304'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'FormSchema'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SchemaJson'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'FormSchema'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'MetadataJson'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'FormSchema'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'ResultJson'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'FormSchemaResult'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
